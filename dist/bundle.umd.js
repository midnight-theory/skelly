(function (global, factory) {
    ...
    (global = global || self, factory(global.Skelly = {}));
    ...
    */
    ...
    // Styles
    const backgroundColor = '#DFDFDF';
    const InitSkellyShine = () => {
    ...
    const setColor = ({
      ...
      if (dark) return color(color$1).darken(multiplier).saturate(saturation).rgb();else return color(color$1).lighten(multiplier).saturate(saturation).rgb();
    };
    ...
    const colorStops = ({
      ...
      return [`rgba(${lightColorString}, 0) 0%`, `rgba(${lightColorString}, ${lightOpacity * 0.5}) 12.5%`, `rgba(${lightColorString}, ${lightOpacity}) 25%`, `rgba(${lightColorString}, ${lightOpacity * 0.5}) 37.5%`, `rgba(${lightColorString}, 0) 50%`, `rgba(${darkColorString}, 0) 50%`, `rgba(${darkColorString}, ${darkOpacity * 0.5}) 62.5%`, `rgba(${darkColorString}, ${darkOpacity}) 75%`, `rgba(${darkColorString}, ${darkOpacity * 0.5}) 87.5%`, `rgba(${darkColorString}, 0) 100%`].join(',');
    };

    // Styles
    const InitSkellyCircle = () => {
    ...
    exports.InitSkellyCircle = InitSkellyCircle;
    exports.InitSkellyRectangle = InitSkellyRectangle;
